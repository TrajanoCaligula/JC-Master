...
function Hat(x, y, map)
{
	...
	var hat = new Texture("Textures/Levels/Wheel.png");

	// Prepare PIRATE sprite & its animations
	this.sprite = new Sprite(x, y, 64, 64, 20, hat);
	...
	this.sprite.addKeyframe(HAT_BORN, [224, 0, 32, 32]);
	this.sprite.addKeyframe(HAT_BORN, [256, 0, 32, 32]);
	...
	this.sprite.addKeyframe(HAT_LEFT, [160, 32, 32, 32]);
